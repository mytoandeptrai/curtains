...
```bash
INIT=$(node "/Users/macbookpro/Desktop/Projects/curtains/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/macbookpro/Desktop/Projects/curtains/.claude/get-shit-done/templates/spec.md.
