...
```
Agent(
  prompt="Read /Users/macbookpro/Desktop/Projects/curtains/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/macbookpro/Desktop/Projects/curtains/.claude/get-shit-done/templates/SECURITY.md`
