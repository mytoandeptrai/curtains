...
- **Global scope**: `/Users/macbookpro/Desktop/Projects/curtains/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/macbookpro/Desktop/Projects/curtains/.claude/notes/`)
...
2. Glob `/Users/macbookpro/Desktop/Projects/curtains/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/macbookpro/Desktop/Projects/curtains/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/macbookpro/Desktop/Projects/curtains/.claude/notes/` — works in any directory
