...
import type { ProductEdit, ProductVariant } from '@/lib/schemas/product';
...
export function ProductEditForm({ onSubmit, isLoading, categoryOptions, defaultValues }: ProductEditFormProps) {
