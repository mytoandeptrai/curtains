...
import { useGetLeadList, type ILead } from '@/api/leads';
...
export function useLeadListContainer(): UseLeadListContainerReturn {
  ...
  const { data, isLoading, isFetching } = useGetLeadList(
    {
      page: query.page,
      ...
      search: query.search,
      status: query.status as 'new' | 'contacted' | 'closed' | undefined,
    },
    {
