...
interface BlogEditUIProps {
  onSubmit: (data: BlogEdit) => Promise<void>;
  isLoading: boolean;
  defaultValues?: Partial<BlogEdit>;
}

export function BlogEditUI({ onSubmit, isLoading, defaultValues }: BlogEditUIProps) {
  ...
  return (
    <FormWrapper form={form} onSubmit={onSubmit} className="space-y-6">
        ...
        <FormCheckbox
          ...
          name="published"
          label="Published"
          checkboxLabel="Publish this post"
        />
